...
↯︙❬ .تغيير اسمي + كتابه الاسم ❭ . تغيير اسمي تيتو
...
↯︙[لمشاهدة الشرح فيديو من هنا |](https://t.me/K_O_O0/850)
"""
txx2 = """
...
async def back(client, callback_query):
  await callback_query.edit_message_text("↯︙❬ م1 ❭ اوامر الخاص\n↯︙❬ م2 ❭ اوامر القنوات والمجموعات\n↯︙❬ م3 ❭ اوامر اليوتيوب\n↯︙❬ م4 ❭ اوامر الاذاعه\n↯︙❬ م5 ❭ اوامر التسليه\n↯︙❬ م6 ❭ اوامر اضافيه",reply_markup = InlineKeyboardMarkup(
            [[
             ...
             [
             InlineKeyboardButton("◜᥉᥆ᖇᥴ꧖◞",url="https://t.me/K_O_O0"),
             ],
             [
             InlineKeyboardButton("◜ꪔY ժᥱ᥎◞",url="https://t.me/R_V_2"),
             ]]
             ))
...
async def get_pos(c,msg):
    ...
    if typing : 
        ...
        await app.send_animation(chat_id,typing,caption='By : @R_V_2')
        remove(typing)
