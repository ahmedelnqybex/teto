...
def insts(link):
    ...
    if res["status"] == "ok":
        ...
        return {"status":"Done","vedio":vedio,"POWEREDBY":"@R_V_2"}
    else:
        return {"status":"none","POWEREDBY":"@R_V_2"}
def social(link):
    headers = {
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; M2004J19C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36',
    ...
    data = {
    'url': link,
    'token': '0fcb48c1f14fee946c2af864af52c3d416d01634858e2c6f102194b0c647c4f6',
}
