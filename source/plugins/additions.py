...
async def tota(c, msg):
    await msg.edit(
        "———————×———————\n **⎈ ⦙  قائـمه اوامر الزغرفه :** \n⎈ ⦙  `.المواليد ` \n⎈ ⦙  `.اشهر مزغرفة` \n⎈ ⦙  `.البايو` \n⎈ ⦙  `.قنوات` \n⎈ ⦙  `.الرموز` \n⎈ ⦙  `.اسماء` \n [Ⴆ᥆ƚ τєτσ](http://t.me/t_t_e_e_t_t_o_obot)\n———————×———————") 


@Client.on_message(filters.command(["اوامري$", "اوامر السورس$"], prefixes=f".") & filters.me)
async def more(c, msg):
    await msg.edit(
        "❨ Order telethon Teto  ❩\n———————×———————\n⍣⃟🝳  اوامر الخاص ↢ ( .م1 )\n⍣⃟🝳  اوامر المجموعات ↢ ( .م2 )\n⍣⃟🝳  اوامر اليوتيوب  ↢ ( .م3 )\n⍣⃟🝳  اوامر الاذاعه ↢ ( .م4 )\n⍣⃟🝳  اوامر الرفع ↢ ( .م5 )\n⍣⃟🝳  اوامر النسب ↢ ( .م6 )\n⍣⃟🝳  اوامر اضافيه  ↢ ( .م7 )\n⍣⃟🝳  اوامر التسلية 1 ↢ ( .م8 )\n⍣⃟🝳  اوامر التسلية 2 ↢ ( .م9 )\n⍣⃟🝳  اوامر الزخرفه ↢ ( .م10 )\n⍣⃟🝳  اوامر المميز ↢ ( .م11 )\n⍣⃟🝳  اوامر الفارات ↢ ( .م12 )\n⍣⃟🝳  اوامر التوقيت↢ ( .م13 ) \n⍣⃟🝳  اوامر الالعاب↢ ( .م14 ) \n⍣⃟🝳  اوامر التسليه والكاركتير↢ ( .م15 ) \n⍣⃟🝳  اوامر الوقتيه↢ ( .م16 ) \n———————×———————\n✷ مطور السورس : ( @R_V_2 ) .\n✷ قناه السورس : ( @K_O_O0 ) .\nجميع الاوامر تكون بدايتها نقطة .")
...
async def botattt(c, msg):
    await msg.edit(
        "[𝐓𝐄𝐓𝐎](http://t.me/t_t_e_e_t_t_o_obot)")
