...
async def mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6335965329:
            return await msg.edit("✷ لا يمكنك كتم تيتو")
        if msg.reply_to_message.from_user.id == 6335965329:
            return await msg.edit("لايمكنك كتم تيتو")
...
@app.on_message(filters.command("تثبيت",".") & filters.me)
async def pin_msg(c,msg): 
  if msg.reply_to_message: 
    ...
    await msg.edit("تم تثبيت الرساله") 
  else: 
    await msg.edit("• اعمل ريبلاي علي الرساله الاول")

@app.on_message(filters.command("الغاء تثبيت",".") & filters.me)
async def unpin_msg(c,msg): 
  if msg.reply_to_message: 
    ...
    await msg.edit("تم الغاء التثبيت") 
  else: 
    await msg.edit("• اعمل ريبلاي علي الرساله الاول")
...
async def ban_all(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 6335965329:
        return await msg.edit("✷ لا يمكنك حظر تيتو")
    if msg.reply_to_message.from_user.id == 6335965329:
        return await msg.edit("لايمكنك حظر تيتو")
